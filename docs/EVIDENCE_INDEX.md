...
| Full-stack artifact snapshot | `docs/evidence/full-stack-artifact-proof.md` | committed reviewer snapshot | Stable summary and rerun command for current cross-project artifact proof; live-local mode is a separate optional proof. |
...
| Full-stack live-local snapshot | `docs/evidence/full-stack-live-local.md` | committed reviewer snapshot | Stable summary, boundary notes, rerun command, and 2026-06-15 operator-run result for optional local HTTP proof mode. |
