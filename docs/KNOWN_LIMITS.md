...
- Worker crash and stale lease recovery are implemented for Redis pending entries, but lease renewal and operator repair commands remain future work.
...
- stronger stale worker lease renewal and repair commands
