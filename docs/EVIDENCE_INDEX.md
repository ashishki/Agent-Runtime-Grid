...
| Full-stack live-local snapshot | `docs/evidence/full-stack-live-local.md` | committed reviewer snapshot | Stable summary, boundary notes, and rerun command for optional local HTTP proof mode. |
